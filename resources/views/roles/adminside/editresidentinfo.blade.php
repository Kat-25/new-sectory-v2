                      ...
                      <div class="col-md-10 mx-auto shadow bg-dark">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <form class="m-5 justif-content-center" action="/updateres" method="post">
                                @csrf
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <label class="form-label" for="householdno">First Name:</label>
                                    <input class='form-control' type="text" name="firstnameh" id='firstnameh' value="{{$residents['firstName']}}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="addressh">Gender:</label>
                                    <input class="form-control" type="text" id="genderh" name="genderh" value="{{$residents['userGender']}}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="purokleaderh">Citizenship:</label>
                                    <input class="form-control" type="text" id="citizenshiph" name="citizenshiph" value="{{$residents['userCitizenship']}}">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="residentstatush">Account Status:</label>
                                    <select id="residentstatush" name="residentstatush" class="form-select" aria-label="Default select civil status">
                                ...
                                <br>
                                <div class="me-6">
                                    <button type="submit" name="submit" class="form-control btn btn-primary">Update Resident Info</button>
                                </div>
                            </form>                
                              <br>
