...
<body id="page-top" class="bg-gray-400">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                       ...
                       <!-- MultiStep Form -->
                            <div class="container-fluid bg-gray-400" id="grad1">
                                <div class="row justify-content-center mt-0">
                                    <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
                                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                            <h2><strong>Register Account</strong></h2>
    ...
    <script src="{{ asset('css/script_style.js') }}"></script>
    ...
    {{-- <script>
        $(document).ready(function() {
            $('#householdno').keyup(function() {
                var householdNo = $(this).val();
                $.ajax({
                    url: '/get-household-id',
                    data: { householdNo: householdNo },
                    success: function(response) {
                        $('#householdid').val(response.household_id);
                    }
                });
            });
        });
    ...
    {{-- <script>
        $(document).ready(function() {
            $('#householdno').on('keyup', function() {
                var householdNo = $(this).val();
                if (householdNo.length != 0) {
                    $.ajax({
                        url: '/get-household-id',
                        type: 'get',
                        data: { householdNo: householdNo },
                        success: function(data) {
                            $('#householdid').val(data.householdId);
                        }
                    });
                } else {
                    $('#householdid').val('');
