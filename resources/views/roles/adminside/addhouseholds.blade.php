            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ADD HOUSEHOLD</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class="m-5 justif-content-center" action="addhouseholds1" method="post">
                                @csrf
                                <div class="mb-2">
                                    <label class="form-label" for="householdno">Household No:</label>
                                    <input class='form-control' type="text" name="householdno" id='householdno'>
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="addressh">Address:</label>
                                    <input class="form-control" type="text" id="addressh" name="addressh">
                                </div>
                                <div class="mb-2">
                                    <label class="form-label" for="purokleaderh">Purok Leader:</label>
                                    <input class="form-control" type="text" id="purokleaderh" name="purokleaderh">
                                </div>
                                <div class="mb-2">
                                ...
                                <br>
                                <div class="me-6">
                                    <button type="submit" name="submit" class="form-control btn btn-primary">Add Household</button>
                                </div>
                            </form>
